...
def get_stats(): return jsonify(db.get_stats_data())
...
UPLOAD_FOLDER = os.path.join(current_dir, 'backend', 'assets', 'images')
...
def add_product():
    ...
    success = database.admin_add_product(name, category, price, image_filename)
...
def update_product():
    ...
    success = database.admin_update_product(pid, name, category, price, image_filename)
    return jsonify({'success': success})
...
def get_report(): return jsonify(db.admin_get_report_data())
...
admin@raspberrypi:~/SmartKiosk1/kiosk_app $ python api_server.py 
Traceback (most recent call last):
  File "/home/admin/SmartKiosk1/kiosk_app/api_server.py", line 9, in <module>
    import backend.database as db
  File "/home/admin/SmartKiosk1/backend/database.py", line 167
